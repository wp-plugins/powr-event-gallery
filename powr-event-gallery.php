<?php
    ...
    Description: Showcase upcoming events in a beautiful Pinterest-style gallery!  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.4
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////Create Event Gallery widget/////////////////////////////////
    class Powr_Event_Gallery extends WP_Widget{
      //Create the widget
      public function __construct(){
        parent::__construct( 'powr_event_gallery',
                             __( 'POWr Event Gallery' ),
                             array( 'description' => __( 'Event Gallery by POWr.io') )
        );
      }
      //This prints the div
      public function widget( $args, $instance ){
        ...
        ?>
        <div class='widget powr-event-gallery' label='<?php echo $label; ?>'></div>
        <?php
      }
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Event Gallery.
        </p>
        <p>
    ...
    function register_powr_event_gallery() {
      register_widget( 'Powr_Event_Gallery' );
    }
    //Use widgets_init action hook to execute custom function
    add_action( 'widgets_init', 'register_powr_event_gallery' );
    //Create short codes for adding plugins anywhere:
    function powr_event_gallery_shortcode( $atts ){
      if(isset($atts['label'])){
        $label = $atts['label'];
      }else{
        $label = '';
      }
      return "<div class='powr-event-gallery' label='$label'></div>";
    }
    add_shortcode( 'powr-event-gallery', 'powr_event_gallery_shortcode' );
