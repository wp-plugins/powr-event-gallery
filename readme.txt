...
= How do I add Event Gallery to a page or blog post? = Add the shortcode **[powr-event-gallery label='Enter any label here']** to any page or post. Then visit your live site to edit.

= Can I add more than one Event Gallery? = Yes, absolutely!  To clone your Event Gallery, just add the exact same shortcode to pages or posts.  To create a new version of Event Gallery, add a different shortcode to each page or post, for example: **[powr-event-gallery label='first form']**, and **[powr-event-gallery label='second form']**.
